...
export const issues: Issue[] = [
  ...
  },
  {
    ...
    messageParagraph:
      'People are sleeping on sidewalks, families are one paycheck from eviction, and corporate landlords are hoarding housing as a speculative asset—all in one of the wealthiest nations in human history. This is a policy choice, not an inevitability. I demand that you support massive investment in social and public housing, enforceable tenant protections, rent stabilization, and aggressive action against real estate speculation. Every night someone sleeps outside while apartments sit empty is a moral indictment of our priorities. This crisis demands emergency-level action now.',
  },
  {
    id: 'student-debt',
    ...
    messageParagraph:
      'An entire generation has been shackled with crushing, inescapable debt for the act of pursuing an education—a burden that delays homeownership, prevents family planning, and drives people into financial ruin. This was a deliberate policy choice, and it can be undone. I demand that you support the full cancellation of federal student debt immediately and fund tuition-free public higher education so no one else is trapped by this system. The longer you wait, the deeper the damage. People cannot afford your inaction.',
  },
  {
